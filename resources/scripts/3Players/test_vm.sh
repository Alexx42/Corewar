...
#    Updated: 2018/09/17 09:07:27 by mcarney          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
# **************************************************************************** #
...
do
	...
	do
		...
		do
			...
			OUTPUT="${NAME1}_vs_${NAME2}_vs_${NAME3}.output"
			...
			./corewar ./Champs/$P1 ./Champs/$P2 ./Champs/$P3 -dump $1 > ./MCOREWAR_OUTPUT/$OUTPUT
			./r_corewar ./Champs/$P1 ./Champs/$P2 ./Champs/$P3 -d $1 > ./RCOREWAR_OUTPUT/$OUTPUT

			DIFF=$(diff ./RCOREWAR_OUTPUT/$OUTPUT ./MCOREWAR_OUTPUT/$OUTPUT)

			if [ "$DIFF" = "" ]; then
				printf "${GREEN}$P1 VS $P2 VS $P3 ✔ ${NC}\n"
			else
				printf "${RED}$P1 VS $P2 VS $P3 ✘ (REAL COREWAR IN FIRST)${NC}\n"
