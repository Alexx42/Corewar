...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/01 07:51:03 by acakste           #+#    #+#             */
/*   Updated: 2018/11/06 15:10:45 by tkobb            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ld_op(t_process *process, t_exc_instr *instr)
{
	...
	{
		offset = convert_reg_uint(instr->params[0].mem, instr->params[0].len);
