...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/01 07:52:43 by acakste           #+#    #+#             */
/*   Updated: 2018/11/12 08:10:46 by dprevost         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			lfork_op(t_process *p, t_exc_instr *instr, t_process **processes)
{
	uint64_t	value;
